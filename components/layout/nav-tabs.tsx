...
/**
 * Active-tab nav for the AppHeader. Tiny client island so the active state
 * tracks client-side `<Link>` navigations — server reading of `x-pathname`
 * only updates on full requests, so soft nav leaves the indicator stuck
 * on the first-loaded route. usePathname() re-renders on every nav.
 */
